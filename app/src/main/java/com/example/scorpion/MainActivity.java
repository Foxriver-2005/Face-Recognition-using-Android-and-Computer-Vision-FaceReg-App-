...
import com.example.scorpion.mobilefacenet.MobileFaceNet;
...
public class MainActivity extends AppCompatActivity {
    ...
    private final String FILE_PROVIDER_PATH = "com.example.scorpion.fileprovider";
    ...
    private void run_live_camera() {
        ...
        builder.setItems(options, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int item) {
                if (options[item].equals("Front Facing Camera")) {
...
//        String storagePath = module.equals("register") ? Environment.DIRECTORY_PICTURES : Environment.DIRECTORY_PODCASTS;
    ...
    private void register_face(Uri uri, String module, String person_name) {
        try {
            ...
            bitmap = Helper.detect_and_crop_face(MainActivity.this, mtcnn, bitmap,textView);
    ...
    private void recognize_face(Uri uri, String module) {
        try {
            ...
            new_image = Helper.detect_and_crop_face(MainActivity.this, mtcnn, new_image,textView);
                ...
                if (registered_faces_path.exists()) {
                    ...
                    for (File face_data : faces) {
                        ...
                        if (isSame) {
                            ...
                            break; // To break out of the loop once the match is found
                        } else {
